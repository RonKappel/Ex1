...
public class WGraph_DS implements weighted_graph
{
	...
	protected static class NodeInfo implements node_info , Comparable<NodeInfo>
	{
		private int key;
		private double tag;
		private String Info;
		...
		public int compareTo(NodeInfo other)
		{
			...
			else if(tag>other.tag)return 1;
			else return 0;
		}
		@Override
		public int getKey()
	...
	protected static class Edge
	{
		...
		public Edge(double Price)
		{
			if(Price<0)
			{
				System.err.println("not Possitive edge the price will set as 0");
				this.Price=0;
			}
		 ...
		 while(iteG1.hasNext() )
		 {
			 ...
			 while(iteNiG1.hasNext())
			 {
				 ...
				 if(G1.getEdge(N1.getKey(), Ni1.getKey())!=G2.getEdge(N2.getKey(), Ni2.getKey()))
					 {
					 	System.err.println("Diffrent edge ");
					 	return false;
					 }
			 } 
		 }
